 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@codeforge/contracts";
...
>()("codeforge/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
