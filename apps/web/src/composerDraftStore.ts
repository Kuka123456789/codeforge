...
import { getDefaultModel, normalizeModelSlug } from "@codeforge/shared/model";
...
import { UnifiedSettings } from "@codeforge/contracts/settings";

export const COMPOSER_DRAFT_STORAGE_KEY = "codeforge:composer-drafts:v1";
