  ...
  return (
    <SidebarInstanceContext.Provider value={instanceContextValue}>
      ...
      >
        ...
        >
          <div
            className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm/5 [&>[role=presentation]]:!absolute [&>[role=presentation]]:!pointer-events-none"
            data-sidebar="sidebar"
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "flex min-h-0 flex-1 w-full min-w-0 flex-col gap-2 overflow-y-auto group-data-[collapsible=icon]:overflow-hidden",
        className,
      )}
